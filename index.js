import{a as I,S as ee,R as U,i as b,O as _}from"./assets/vendor-Dr6RkfKe.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const a of i)if(a.type==="childList")for(const n of a.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function s(i){const a={};return i.integrity&&(a.integrity=i.integrity),i.referrerPolicy&&(a.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?a.credentials="include":i.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(i){if(i.ep)return;i.ep=!0;const a=s(i);fetch(i.href,a)}})();const te="https://sound-wave.b.goit.study/api",H=1,P=8;I.defaults.baseURL=te;async function j(e,t={},s=""){var r,i;try{return(await I({url:e,method:s,...t})).data}catch(a){const n=((i=(r=a.response)==null?void 0:r.data)==null?void 0:i.message)||a.message;throw new Error(`Failed to load ${e}: ${n}`,{cause:a})}}const S={get:(e,t={})=>j(e,t,"get"),post:(e,t,s={})=>j(e,{...s,data:t},"post")};function se(e=1,t=10){return S.get("/feedbacks",{params:{page:e,limit:t}})}function re(e){return console.log("📤 Sending to backend:",e),S.post("/feedbacks",e)}const k=new ee(".swiper",{loop:!1,navigation:{nextEl:".feedback-btn-next",prevEl:".feedback-btn-prev",disabledClass:"is-disabled"},pagination:{el:".swiper-pagination",clickable:!1,renderBullet:function(e,t){return e<3?`<span class="${t}" data-index="${e}"></span>`:""}},on:{slideChange:function(){const e=document.querySelectorAll(".swiper-pagination-bullet"),t=this.slides.length,s=this.realIndex;e.forEach(r=>r.classList.remove("swiper-pagination-bullet-active")),s===0?e[0].classList.add("swiper-pagination-bullet-active"):s===t-1?e[2].classList.add("swiper-pagination-bullet-active"):e[1].classList.add("swiper-pagination-bullet-active")}}});document.querySelector(".feedback-btn-next");document.querySelector(".feedback-btn-prev");document.querySelector(".swiper-pagination").addEventListener("click",function(e){const t=e.target;if(t.classList.contains("swiper-pagination-bullet")){const s=parseInt(t.getAttribute("data-index")),r=k.slides.length;s===0?k.slideTo(0):s===1?k.slideTo(1):s===2&&k.slideTo(r-1)}});const z=`
...
`,D=e=>`data:image/svg+xml;charset=utf-8,${encodeURIComponent(e)}`,ie=D(z),ae=D(Y);function ne(){document.querySelectorAll(".feedback-stars-rating").forEach(t=>{var i;if(t.dataset.ratyInitialized==="true")return;let s=Number(t.dataset.score);Number.isNaN(s)&&(s=0),s=Math.round(s),s=Math.max(0,Math.min(5,s));const r=new U(t,{readOnly:!0,score:s,number:5,halfShow:!1,starType:"img",starOn:ie,starOff:ae,space:!1});(i=r.init)==null||i.call(r),t.dataset.ratyInitialized="true"})}const oe=document.querySelector(".feedback-swiper-wrapper");function le({data:e}){const t=e.map(({name:s,rating:r,descr:i})=>`
  ...
  `}function E(e){e&&(e.querySelector(`.${M}`)||e.insertAdjacentHTML("beforeend",ye()))}function C(e){if(!e)return;const t=e.querySelector(`.${M}`);t&&t.remove()}const ke=document.querySelector(".js-artists"),c=document.querySelector(".load-more-btn");function R(e){return e.map(Le).join("")}function Le({_id:e,strArtist:t,strBiographyEN:s,strArtistThumb:r,genres:i}){const a=V({name:t,imageUrl:r});return`<li class="artist-card" data-id="${e}">
  ${a}
  </div>
          <div class="artist-card-body">
            <ul class="tag-list">
  ...
  `)}function F(e){return!e||e==="0"?null:e}function Ce(e={},t){const s=Array.isArray(e.genres)?e.genres.map(u=>`<li class="genre-item">${u}</li>`).join(""):"",r=F(e.intFormedYear),i=F(e.intDiedYear),a=V({name:e.strArtist,imageUrl:e.strArtistThumb,className:"artist-ill"}),n=`<div class="meta-row">
            <dt>Years active</dt>
